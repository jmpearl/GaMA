...
mesh = mesh.setNumFaces(23500);
while mesh.numVertices>1050
    mesh=mesh.coarsen(mesh.numFaces-500);
    mesh=mesh.smooth(10,'uniform',false);
    mesh.coordinates=meshOriginal.project(mesh.coordinates,mesh.vertexNormals());
    mesh=mesh.coarsen(mesh.numFaces-1);
    %mesh = mesh.center();
