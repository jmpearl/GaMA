classdef HandleSurfaceMesh < handle
%==========================================================================
...
%--------------------------------------------------------------------------
    ...
    methods
        function obj = HandleSurfaceMesh(mesh)
        % constructor
        %------------------------------------------------------------------
        % Input:
        ...
        %-----------------------------------------------------------------
            ...
            count = 0;
            %disp(any(pairi ~= startingEdge) || count == 0)
        ...
        %------------------------------------------------------------------
            ...
            % make a copy
            meshTemp = HandleSurfaceMesh(obj);
...
%                     end
                    ...
                    % update vertex angles from collapse
                    %------------------------------------------------------
