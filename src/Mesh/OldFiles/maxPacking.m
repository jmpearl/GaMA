function [ cm ] = maxPacking( pts,f,ds )
%=========================================================================%
...
% uniform grid. Called FP method by Simon Tardivel in his paper:
% "The Limits of the Mascons Approximation of the Homogeneous Polyhedron"
%
% Inputs:
...
% offset grid 1/2 a unit in the x and y
X2 = X1+ds/2;
Y2 = Y1+ds/2;
Z2 = Z1;

% offset grid 1/2 a unit in the x and z
X3 = X1+ds/2;
Y3 = Y1;
Z3 = Z1+ds/2;

% offset grid 1/2 a unit in the y and z
X4 = X1;
Y4 = Y1+ds/2;
Z4 = Z1+ds/2;
